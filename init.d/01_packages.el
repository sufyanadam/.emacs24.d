...
;; met.
(setq sa-dependent-packages
      '(;org2blog 
	; gist
	sass-mode))


(el-get 'sync (mapcar 'prin1-to-string sa-packages))
(el-get 'sync (mapcar 'prin1-to-string sa-dependent-packages))
